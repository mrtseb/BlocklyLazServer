...
Blockly.Blocks['grove_dht11'] = {
  helpUrl: 'https://www.trossenrobotics.com/Shared/images/PImages/DF-DFR0067-a.jpg',
  init: function() {
    this.setColour(190);
    this.appendDummyInput()
        .appendField("DHT11")
        .appendField(new Blockly.FieldImage("../../media/devices/grove_dht11.jpg", 64, 64))
        .appendField("PIN#")
        .appendField(new Blockly.FieldDropdown(profile.default.digital), "PIN")
		.appendField("MES#")
        .appendField(new Blockly.FieldDropdown([["Temperature.", "temp"], ["Humidite.", "hum"]]), "MESURE");
    this.setOutput(true, 'Boolean');
    this.setTooltip('Dht');
  }
};
...
Blockly.Blocks['grove_relay'] = {
  ...
  init: function() {
    ...
    this.appendDummyInput()
        .appendField("Relais")
        .appendField(new Blockly.FieldImage("../../media/devices/grove_relais.jpg", 64, 64))
        .appendField("PIN#")
        .appendField(new Blockly.FieldDropdown(profile.default.digital), "PIN")
        .appendField("stat")
        .appendField(new Blockly.FieldDropdown([["HIGH", "HIGH"], ["LOW", "LOW"]]), "STAT");
...
Blockly.Blocks['grove_serial_lcd_iic'] = {
  helpUrl: 'http://www.seeedstudio.com/wiki/index.php?title=GROVE_-_Starter_Bundle_V1.0b#Serial_LCD',
  init: function() {
    this.setColour(190);
    this.appendDummyInput()
    ...
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setTooltip('print text on an 16 character by 2 line LCD I2C.');
  }
};
