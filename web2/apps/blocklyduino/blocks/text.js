...
Blockly.Blocks['text2'] = {
	...
	this.appendValueInput('TXT1')
	     .appendField('concaténer');
    this.appendValueInput('TXT2')
		 .appendField('et');
    this.setInputsInline(true);
	this.setOutput(true, 'String');
    this.setTooltip("Concatenation de deux textes");
  }
...
Blockly.Blocks['text_var2string'] = {
  /**
   * Block for appending to a variable in place.
   * @this Blockly.Block
   */
  init: function() {
    ...
    this.setColour(Blockly.Blocks.texts.HUE);
	this.appendDummyInput()
	    .appendField('convertir en chaîne:')
